// import ImageCircle from "../00_div_image";
import ImageCircle from "../../00_imagecircle";
    ...
    <S.card>
      <S.Container>
        <S.box1>
          ...
          <S.TextBox>
            <S.MainTitle>코카콜라 리디자인 프로젝트</S.MainTitle>
            <S.SubTitle>코카콜라 브랜드 로고 디자인</S.SubTitle>
          </S.TextBox>
        </S.box1>

        <S.box2>
          <ImageCircle />
          <S.Title01>{props.projectName01}Z세대 X 나이키 프로젝트</S.Title01>
          <S.Title02>
            {props.projectName02}
